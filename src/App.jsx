        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          <button onClick={() => setMode("guide")}
            ...
            <div style={{ display:"flex", alignItems:"center", gap:14 }}>
              <img src="/mascot/beginner.png" alt="" style={{ width:72, height:72, objectFit:"contain", flexShrink:0 }} />
              <div>
                <div style={{ fontSize:17, fontWeight:800, color:"#fff", marginBottom:4 }}>초보자</div>
                <div style={{ fontSize:13, color:"rgba(255,255,255,0.8)" }}>렌토리와 함께 장비를 골라요!</div>
              </div>
            </div>
          </button>
