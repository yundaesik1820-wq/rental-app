...
export default function FacilityReserve() {
  ...
  return (
    <div>
      {/* 렌토리 배너 */}
      <div style={{ background:"linear-gradient(135deg,#0D9488,#0891B2)", borderRadius:16, padding:"14px 16px", marginBottom:20 }}>
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div style={{ position:"relative", background:"#fff", borderRadius:12, padding:"10px 14px", flex:1 }}>
            ...
            <div style={{ fontSize:12, fontWeight:700, color:"#1B2B6B", marginBottom:3 }}>여기는 시설 대여 신청 페이지야!</div>
            <div style={{ fontSize:11, color:"#475569", lineHeight:1.5 }}>아래에서 예약할 시설을 골라봐.<br/>스튜디오, 편집실 등을 예약할 수 있어 🏢</div>
          </div>
        </div>
      </div>
