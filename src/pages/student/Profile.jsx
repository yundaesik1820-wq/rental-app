      ...
      <div style={{ background: P.card, border: `1px solid ${P.border}`, borderRadius: 12, padding: "14px 16px", marginBottom: 10 }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          ...
          <button onClick={async () => {
            ...
            style={{ width:48, height:22, minWidth:48, padding:0, boxSizing:"border-box", borderRadius:11, border:"none", cursor:"pointer", background:ttPublic?P.blue:"#2A2A31", position:"relative", transition:"background 0.2s", flexShrink:0 }}>
